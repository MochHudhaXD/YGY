...
global.ownerName = '𝓓𝓱𝓪 𝓞𝓦𝓝𝓔𝓡 '
global.ownerNumber = ["6283174295037@s.whatsapp.net"]
global.packname = '𝙱𝚢'
global.author = '𝓓𝓱𝓪 𝓑𝓞𝓣'
global.prefa = ['','.']
global.mess = {
    wait: 'Tunggu Bwanhh!!',
    succes: 'Gimana Bwanh?',
...
let buttons = [      
                ...
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/ba2d4edecb84dfcc6dd2b.jpg' },
                    caption: `${jiren}`,
                    footer: `𝓓𝓱𝓪 𝓑𝓞𝓣`,
                    buttons: buttons,
                    headerType: 4
...
`
let buttons = [      
                    {buttonId: `4ks`, buttonText: {displayText: '𝓓𝓱𝓪 𝓑𝓞𝓣'}, type: 1}         
                ]
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/ba2d4edecb84dfcc6dd2b.jpg' },
                    caption: `${jiren}`,
...
break
case '4ks':{
diablobotwhatsapp.reply ('𝓓𝓱𝓪 𝓞𝓦𝓝𝓔𝓡 ') 
}
break
case 'waifu':
    case 'loli':
...
break
	    case 'donasi': case 'd': case 'd': case 'd': case 'donate': {
                diablo.sendMessage(diablobotwhatsapp.chat, { image: { url: 'https://telegra.ph/file/70d631f04bb2bef097668.jpg' }, caption: `Hai Kak ${diablobotwhatsapp.pushName}\n\n DANA: SCAN\n\n GOPAY:  SCAN\n\n MAU DONATE LAIN? QRISS :\n\n` }, { quoted: diablobotwhatsapp })
            }
            break
...
case 'menfess':
			...
			case 'confess':
				...
				header = 'hayyy'
					gambar = `https://telegra.ph/file/ba2d4edecb84dfcc6dd2b.jpg`

				 but = [
					{ urlButton: { displayText: `Create 𝙱𝚢`, url : `𝓓𝓱𝓪 𝓞𝓦𝓝𝓔𝓡 ` } },
					...
					diablo.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://telegra.ph/file/ba2d4edecb84dfcc6dd2b.jpg`}, templateButtons: but, footer: `Ciee ada yang ngirim pesan nih\nJangan lupa bales pesannya ya` })
				diablobotwhatsapp.reply(`Sukses Mengirim Menfess!!`)
				break
            case 'janda': {
                if (!itsMediablo) throw mess.owner
                diablo.public = false
                diablobotwhatsapp.reply('BOT MODE JANDA ANAK 10🗿😭')
            }
            break
            case 'public': {
                if (!itsMediablo) throw mess.owner
                diablo.public = true
                diablobotwhatsapp.reply('BOT MODE PERAWAN 😭')
            }
            break
case 'ytmp3':
...
break
case 'akses':
diablobotwhatsapp.reply(`UNTUK AKSES BOT CHAT OWNER : wa.me/6281236167286`)
break
case 'sewa':
diablobotwhatsapp.reply(`UNTUK SEWA BOT CHAT OWNER : wa.me/6281236167286`)
break
case 'join': {
if (!itsMediablo) return diablobotwhatsapp.reply(mess.owner)
